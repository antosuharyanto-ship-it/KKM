...
export const CampBarPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-20 md:pb-10">
            ...
            <button
                onClick={() => navigate('/campbar/trips/safety')}
                className="fixed bottom-24 right-6 z-50 bg-red-600 hover:bg-red-700 text-white rounded-full p-4 shadow-lg border-4 border-red-500/30 animate-pulse transition-transform hover:scale-110 active:scale-95 flex items-center justify-center"
